...
class ShopModel:
    ...
    def __init__(self, player):
        try:
            ...
            self.availableItems = [
                {"name": "Light Beer", "type": "bottle", "price": 8, "category": "Light Beers", "description": "8% alc. Light: +1 damage", "effect": "bottle_light_beer", "alcoholLevel": 8, "bonusDamage": 1, "accuracyPenalty": 0},
                {"name": "Beer", "type": "bottle", "price": 15, "category": "Light Beers", "description": "15% alc. Classic: +3 damage, -5% accuracy", "effect": "bottle_beer", "alcoholLevel": 15, "bonusDamage": 3, "accuracyPenalty": 5},
                {"name": "Mojito", "type": "bottle", "price": 16, "category": "Cocktails", "description": "10% alc. Refreshing: +2 damage", "effect": "bottle_mojito", "alcoholLevel": 10, "bonusDamage": 2, "accuracyPenalty": 0},
                {"name": "Daiquiri", "type": "bottle", "price": 18, "category": "Cocktails", "description": "20% alc. Smooth: +3 damage, -5% accuracy", "effect": "bottle_daiquiri", "alcoholLevel": 20, "bonusDamage": 3, "accuracyPenalty": 5},
                {"name": "Margarita", "type": "bottle", "price": 20, "category": "Cocktails", "description": "25% alc. Tangy: +4 damage, -8% accuracy", "effect": "bottle_margarita", "alcoholLevel": 25, "bonusDamage": 4, "accuracyPenalty": 8},
                {"name": "Piña Colada", "type": "bottle", "price": 24, "category": "Cocktails", "description": "12% alc. Sweet: +2 damage, -3% accuracy", "effect": "bottle_pina_colada", "alcoholLevel": 12, "bonusDamage": 2, "accuracyPenalty": 3},
                {"name": "Vodka", "type": "bottle", "price": 20, "category": "Vodka", "description": "40% alc. Clean: +4 damage, -8% accuracy", "effect": "bottle_vodka", "alcoholLevel": 40, "bonusDamage": 4, "accuracyPenalty": 8},
                {"name": "Rum", "type": "bottle", "price": 25, "category": "Rum Varieties", "description": "50% alc. Classic: +0 damage, restores 50 HP", "effect": "bottle_rum", "alcoholLevel": 50, "bonusDamage": 0, "accuracyPenalty": 0, "hpRestore": 50},
                {"name": "Spiced Rum", "type": "bottle", "price": 26, "category": "Rum Varieties", "description": "38% alc. Fiery: +5 damage, -10% accuracy", "effect": "bottle_spiced_rum", "alcoholLevel": 38, "bonusDamage": 5, "accuracyPenalty": 10},
                {"name": "Whiskey", "type": "bottle", "price": 30, "category": "Whiskey & Spirits", "description": "25% alc. Smooth: +5 damage, -10% accuracy", "effect": "bottle_whiskey", "alcoholLevel": 25, "bonusDamage": 5, "accuracyPenalty": 10},
                {"name": "Scotch", "type": "bottle", "price": 32, "category": "Whiskey & Spirits", "description": "45% alc. Premium: +7 damage, -15% accuracy", "effect": "bottle_scotch", "alcoholLevel": 45, "bonusDamage": 7, "accuracyPenalty": 15},
                {"name": "Cognac", "type": "bottle", "price": 35, "category": "Whiskey & Spirits", "description": "40% alc. Refined: +6 damage, -12% accuracy", "effect": "bottle_cognac", "alcoholLevel": 40, "bonusDamage": 6, "accuracyPenalty": 12},
                {"name": "Tequila", "type": "bottle", "price": 28, "category": "Tequila", "description": "35% alc. Wild: +6 damage, -12% accuracy", "effect": "bottle_tequila", "alcoholLevel": 35, "bonusDamage": 6, "accuracyPenalty": 12},
                {"name": "Absinthe", "type": "bottle", "price": 50, "category": "Extreme", "description": "68% alc. EXTREME: +8 damage, -18% accuracy", "effect": "bottle_absinthe", "alcoholLevel": 68, "bonusDamage": 8, "accuracyPenalty": 18},
        ...
        try:
            ...
            try:
                if item["type"] == "bottle":
                    ...
                    alcoholLevel = item.get("alcoholLevel", 0)
                    bonusDamage = item.get("bonusDamage", 0)
                    accuracyPenalty = item.get("accuracyPenalty", 0)
                    hpRestore = item.get("hpRestore", 0)
                    
                    bottle = BottleModel(item["name"], alcoholLevel, bonusDamage, accuracyPenalty)
                    
                    if hpRestore > 0:
                        currentHp = self.player.getHealth()
                        self.player.setHealth(min(100, currentHp + hpRestore))
                    ...
                    if item["effect"] == "upgrade_damage":
                        ...
                        self.player.setDamage(currentDamage + 3)
                        ...
                        Logger.debug("ShopModel.purchaseItem", "Amplifier purchased", 
                                   newDamage=self.player.getDamage())
