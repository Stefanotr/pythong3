...
class CombatModel:
    """
    Modèle pour gérer l'état d'un combat tour par tour
    """
    ...
    def decrementStatusEffects(self):
        """Décrémenter tous les effets de statut actifs"""
    ...
    def applyBleedingDamage(self):
        """Appliquer les dégâts de saignement"""
    ...
    def resetCombat(self):
        """Réinitialiser le combat (pour recommencer)"""
        self._turn = 1
        self._is_player_turn = True
        self._combat_log = []
        self._combat_finished = False
