...
class CombatController(BaseController):
    ...
    def __init__(self, combat_model, player_view=None, boss_view=None):
        """
        Initialize the combat controller.
        
        Args:
            combat_model: CombatModel instance containing combat state
            player_view: Optional CaracterView for player character (for animations)
            boss_view: Optional CaracterView for boss character (for animations)
        """
        try:
            ...
            # Store character views for animations
            self.player_view = player_view
            self.boss_view = boss_view
    ...
    def playerSimpleAttack(self):
        ...
        Triggers attack animation on player and damage animation on enemy.
        """
        try:
            # Trigger attack animation on player
            if self.player_view:
                self.player_view.setAnimation("attack")
            ...
            if random.randint(1, 100) <= hit_chance:
                ...
                try:
                    ...
                    # Trigger hit animation on enemy
                    if self.boss_view:
                        self.boss_view.setAnimation("hit")
                ...
                # Missed! - trigger dodge animation on boss
                ...
                # Trigger dodge animation on boss when player misses
                if self.boss_view:
                    self.boss_view.setAnimation("dodge")
    ...
    def playerPowerChord(self):
        ...
        Triggers strong attack animation.
        """
        try:
            # Trigger strong attack animation on player
            if self.player_view:
                self.player_view.setAnimation("attack")
            ...
            try:
                ...
                # Trigger heavy hit animation on enemy
                if self.boss_view:
                    self.boss_view.setAnimation("hit")
    ...
    def playerDrink(self):
        ...
        """
        try:
            # Trigger drink animation on player
            if self.player_view:
                self.player_view.setAnimation("drink")
    ...
    def enemySimpleAttack(self):
        ...
        Triggers attack animation on enemy and hit animation on player.
        """
        try:
            # Trigger attack animation on enemy
            if self.boss_view:
                self.boss_view.setAnimation("attack")
            ...
            if random.randint(1, 100) <= hit_chance:
                try:
                    ...
                    if self.player_view:
                        self.player_view.setAnimation("hit")
                ...
                # Boss misses - trigger dodge animation
                ...
                # Trigger dodge animation on player when boss misses
                if self.player_view:
                    self.player_view.setAnimation("dodge")
    ...
    def enemyHeavyAttack(self):
        ...
        """
        try:
            # Trigger strong attack animation on enemy
            if self.boss_view:
                self.boss_view.setAnimation("attack")
