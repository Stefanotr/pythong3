...
class CombatView:
    ...
    def drawFightersInfo(self, screen, combat_model):
        ...
        panel_x = player_x_center - 20
        panel_y = player_y_center - 20
        ...
        self.drawStatusEffects(screen, panel_x + 16, stats_y + stats_h + spacing, combat_model, isPlayer =True)
        ...
        self.drawStatusEffects(screen, enemy_panel_x + 16, enemy_stats_y + stats_h + spacing, combat_model, isPlayer =False)
    ...
    def drawCombatLog(self, screen, combat_model):
        ...
        for message in messages[-10:]:
            try:
                wrapped = self.wrapText(message, max_width)
        ...
        for line in reversed(display_lines):
            try:
                ...
                msg_surf = self.logFont.render(line, True, text_color)
    ...
    def wrapText(self, text, max_width):
        ...
        try:
            ...
            Logger.error("CombatView.wrapText", e)
            return [text]  
