...
class InventoryView:
    ...
    def drawInventoryDisplay(self, screen, inventory_model, x, y):

        try:
            selected_bottle = inventory_model.getSelectedItem()
            selected_index = inventory_model.getSelectedIndex()
            unique_bottles = inventory_model.getUniqueBottles()
    ...
    def drawShopInventory(self, screen, inventory_model, x, y):
