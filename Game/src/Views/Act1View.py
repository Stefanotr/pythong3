    ...
    def __init__(self, screen, player=None):
        ...
        try:
            ...
            try:
                ...
                # Boss: Gros Bill (using motard images) - 180x180 for better visibility
                # Flip horizontal to make boss face opposite direction
                self.boss_view = CaracterView(
                    "Game/Assets/motardquisebaisse (1).png",
                    scale=(180, 180),
                    animation_sprites={
                        "attack": "Game/Assets/motardquidonneuncoupdepied.png",
                        "dodge": "Game/Assets/motardquisebaisse (1).png",
                        "hit": "Game/Assets/motardquisebaisse (1).png"
                    },
                    flip_vertical=False
                )
                ...
                Logger.debug("Act1View.__init__", "Character views created with boss motard sprites", 
                           player_img="lola.png", boss_img="motardquisebaisse (1).png", sprite_scale="180x180")
            except Exception as e:
                Logger.error("Act1View.__init__", e)
            ...
            try:
                ...
                Logger.debug("Act1View.__init__", "Combat system initialized with animations")
            except Exception as e:
                Logger.error("Act1View.__init__", e)
                raise
