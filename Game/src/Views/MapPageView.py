                ...
                if spawn_x is None or spawn_y is None:
                    try:
                        if player_config and 'positions' in player_config:
                            ...
                            h_offset = map_pos.get('horizontal_offset', 50)
                            v_offset = map_pos.get('vertical_offset', 50)
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            self.player_view.drawCaracter(self.screen, self.lola, offset=camera_offset, is_map=True)
                        except Exception as e:
